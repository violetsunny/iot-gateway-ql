...
import top.iot.gateway.reactor.ql.supports.filter.BinaryFilterFeature;
    ...
    static Optional<BiFunction<ReactorQLRecord, Object, Mono<Boolean>>> createPredicateByExpression(Expression expression, ReactorQLMetadata metadata) {
        ...
        expression.accept(new ExpressionVisitorAdapter() {
            ...
            public void visit(IsNullExpression value) {
                ...
                Function<ReactorQLRecord, Publisher<?>> expr = ValueMapFeature.createMapperNow(value.getLeftExpression(), metadata);
                if (not) {
            ...
            public void visit(NotExpression notExpression) {
                Function<ReactorQLRecord, Publisher<?>> mapper = ValueMapFeature.createMapperNow(notExpression.getExpression(), metadata);
                ref.set((row, column) -> Mono
                        .from(mapper.apply(row))
